...
all-examples:
	...
	sed -i 's/8a/aa/' $(KUBASH_DIR)/clusters/openshift/provision.csv
	...
	sed -i 's/8a/ab/' $(KUBASH_DIR)/clusters/kubespray/provision.csv
	...
	sed -i 's/8a/ac/' $(KUBASH_DIR)/clusters/kubeadm2ha/provision.csv
	...
	sed -i 's/8a/ad/' $(KUBASH_DIR)/clusters/centos/provision.csv
	...
	sed -i 's/8a/ae/' $(KUBASH_DIR)/clusters/debian/provision.csv
	...
	sed -i 's/8a/a0/' $(KUBASH_DIR)/clusters/ubuntu/provision.csv
	...
	sed -i 's/8a/a1/' $(KUBASH_DIR)/clusters/coreos/provision.csv
